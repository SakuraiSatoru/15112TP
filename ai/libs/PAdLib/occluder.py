...
class Occluder(object):
    ...
    def intersects(self, point):
        ...
        for l0, l1 in self._padlib_lines:
            ...
            k = affine_segment[0] * affine_point[1] - affine_segment[1] * \
                affine_point[0]
    ...
    def _padlib_collide(self, particle):
        ...
        for l0, l1 in self._padlib_lines:
            ...
            projected_points.append(
                [vec_length_sq(vec_sub(point, particle.position)), point])
        m = 99999999.0
        ...
        for i in range(self.numof_points):
            if projected_points[i][0] == m:
                ...
                particle.velocity = vec_reflect(
                    vec_scale(-self.bounce, particle.velocity),
                    self._padlib_normals[i])
                return
